...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $introductions = Introduction::where('manufacture_id', Auth::id())->get();
 ...
 /**
    ...
    public function chat_index($introduction_id)
    {
        ...
        $chats = Chat::where('manufacture_chat', Auth::id())->where('user_chat', $introduction->user_id)->where('introduction_id', $introduction_id)->get();
